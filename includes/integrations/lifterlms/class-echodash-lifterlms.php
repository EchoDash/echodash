	...
	protected function setup_triggers() {
		...
		$triggers = array(
			...
			'course_progress' => array(
				...
				'description'  => __( 'Triggered whenever a lesson, topic, or quiz is completed within the course, as well as when the course itself is completed.', 'echodash' ),
				'post_types'   => array( 'course' ),
				'has_single'   => true,
				'has_global'   => true,
				'option_id'    => 'course',
			...
			'quiz_completed'  => array(
				...
				'description'  => __( 'Triggered whenever a quiz in this course is marked complete.', 'echodash' ),
				'post_types'   => array( 'course' ),
				'has_single'   => true,
				'has_global'   => true,
				'option_id'    => 'quiz',
