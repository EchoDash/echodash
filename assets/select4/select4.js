...
(function (factory) {
	...
	var S2 = (function () {
		...
		S2.define('select4/utils', ['jquery'], function ($) {
			var Utils = {};
			...
			function ($, Utils) {
				...
				Results.prototype.highlightFirstItem = function () {
					var $options = this.$results.find(
						'.select4-results__option[aria-selected]'
					);
				...
				Results.prototype.bind = function (container, $container) {
					...
					container.on('results:focus', function (params) {
						params.element.addClass(
							'select4-results__option--highlighted'
						);
					});
		...
		S2.define('select4/keys', [], function () {
			var KEYS = {
				BACKSPACE: 8,
				TAB: 9,
				ENTER: 13,
		...
		S2.define(
			...
			function ($, Utils, KEYS) {
				...
				BaseSelection.prototype._attachCloseHandler = function (
					...
					$(document.body).on(
						'mousedown.select4.' + container.id,
						function (e) {
							var $target = $(e.target);
		...
		S2.define(
			...
			function ($, BaseSelection, Utils, KEYS) {
				...
				SingleSelection.prototype.bind = function (
					...
					this.$selection
						.find('.select4-selection__rendered')
						.attr('id', id)
						.attr('role', 'textbox')
		...
		S2.define(
			...
			function (Utils) {
				...
				Placeholder.prototype.createPlaceholder = function (
					...
					$placeholder
						.addClass('select4-selection__placeholder')
		...
		S2.define(
			...
			function ($, KEYS, Utils) {
				...
				AllowClear.prototype.update = function (decorated, data) {
					...
					if (
						this.$selection.find('.select4-selection__placeholder')
							.length > 0 ||
						data.length === 0
					) {
						return;
					...
					var $remove = $(
						'<span class="select4-selection__clear" title="' +
							removeAll() +
							'">' +
							'&times;' +
							'</span>'
		...
		S2.define('select4/selection/eventRelay', ['jquery'], function ($) {
			function EventRelay() {}
		...
		S2.define('select4/diacritics', [], function () {
			var diacritics = {
				'\u24B6': 'A',
				'\uFF21': 'A',
				'\u00C0': 'A',
		...
		S2.define('select4/data/base', ['../utils'], function (Utils) {
		...
		S2.define('select4/data/tags', ['jquery'], function ($) {
		...
		S2.define('select4/data/tokenizer', ['jquery'], function ($) {
		...
		S2.define('select4/data/minimumInputLength', [], function () {
		...
		S2.define('select4/data/maximumInputLength', [], function () {
		...
		S2.define('select4/data/maximumSelectionLength', [], function () {
		...
		S2.define('select4/dropdown/hidePlaceholder', [], function () {
		...
		S2.define('select4/dropdown/infiniteScroll', ['jquery'], function ($) {
			...
			function ($, Utils) {
				...
				AttachBody.prototype._attachPositioningHandler = function (
					...
					var orientationEvent =
						'orientationchange.select4.' + container.id;
				...
				AttachBody.prototype._positionDropdown = function () {
					...
					var isCurrentlyAbove = this.$dropdown.hasClass(
						'select4-dropdown--above'
					);
					var isCurrentlyBelow = this.$dropdown.hasClass(
						'select4-dropdown--below'
					);
					...
					if (newDirection != null) {
						this.$dropdown
							.removeClass(
								'select4-dropdown--below select4-dropdown--above'
							)
							.addClass('select4-dropdown--' + newDirection);
						this.$container
							.removeClass(
								'select4-container--below select4-container--above'
							)
		...
		S2.define('select4/dropdown/minimumResultsForSearch', [], function () {
		...
		S2.define(
			'select4/dropdown/selectOnClose',
			['../utils'],
			function (Utils) {
		...
		S2.define('select4/dropdown/closeOnSelect', [], function () {
		...
		S2.define(
			...
			function ($, Options, Utils, KEYS) {
				...
				select4.prototype._isChangeMutation = function (
					evt,
					mutations
				) {
					var changed = false;
				...
				select4.prototype.render = function () {
					...
					this.$container.addClass(
						'select4-container--' + this.options.get('theme')
					);
				...
				if ($.fn.select4 == null) {
					...
					$.fn.select4 = function (options) {
						...
						if (typeof options === 'object') {
							...
							throw new Error(
								'Invalid arguments for select4: ' + options
							);
						}
					};
				}
